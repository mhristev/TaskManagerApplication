...
class CreateCategoryViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if editCategory != nil {
            ...
            for icon in iconButtons where icon.restorationIdentifier == editCategory?.icon {
                    icon.tintColor = .blue
    ...
    @IBAction func createCategory(_ sender: UIButton) {
        ...
        for button in iconButtons where button.layer.borderWidth == 2 {
        ...
        if editCategory == nil {
            ...
            RealmHandler.updateCategoryWith(ID: editCategory.id,
                                            name: name, icon: icon, color: color, inRealmObject: realm)
